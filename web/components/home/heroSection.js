...
export default function HeroSection ({ heroSection }) {
  ...
  return (
    <div className='relative h-cover'>
      ...
      <main className='absolute mx-10 mt-10 w-2/3 max-w-2xl sm:mt-12 sm:px-6 md:mt-16 lg:mt-20 lg:px-8 xl:mt-28 bg-gray-100 bg-opacity-25'>
        <div className='sm:text-center lg:text-left p-6'>
          <h2 className='text-4xl tracking-tight leading-10 font-bold text-gray-800 sm:text-5xl sm:leading-none md:text-6xl'>
            {title}
          </h2>
